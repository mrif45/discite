...
import 'package:discite/app/models/category.dart';
import 'package:flutter/material.dart';

class PopularListView extends StatefulWidget {
  const PopularListView({Key? key, required this.callBack})
      : super(key: key);
            ...
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final int count = Category.popularCourseList.length > 10
                      ? 10
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                Text(
                                                  '${category.lessonCount} pelajaran',
                                                  textAlign: TextAlign.left,
                                                  style: TextStyle(
